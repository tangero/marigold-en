...
layout: post
original_lang: cs
post_excerpt: We have just experienced two very instructive events that have helped us better understand the dangers posed by AI. It brings “post-truth”—a complete imitation of knowledge that lacks the one thing it needs: knowledge. Everything else is in place. I was sitting in the front row, so I’ll give you a report.
